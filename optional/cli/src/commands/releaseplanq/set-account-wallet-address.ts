...
export default class SetAccountWalletAddress extends ReleasePlanqBaseCommand {
  static description = "Set the ReleasePlanq contract account's wallet address"
  ...
  async run() {
    ...
    await displaySendTx(
      ...
      this.releasePlanqWrapper.setAccountWalletAddress(flags.walletAddress, sig.v, sig.r, sig.s)
    )
  }
}
