...
Examples:
* local-testnet
* local-testnet --local-geth ~/code/planq-blockchain
* local-testnet --validators 5 --proxies 3 --bootnode
* local-testnet --tx-nodes 2 --light-clients 3
* local-testnet --migrate-to 19 --migration-override '{ "lockedPlanq": { "unlockingPeriod": 30 } }'
...
By default, the planq-blockchain repository will be cloned to a temporary location and built from
...
export const builder = (argv: yargs.Argv) => {
  return argv
    .option('local-geth', {
      type: 'string',
      description: 'Local path to planq-blockchain repository.',
    ...
    .option('branch', {
      type: 'string',
      description: 'Branch name for remote planq-blockchain repository.',
    })
    .option('bootnode', {
      type: 'boolean',
      allowNo: true,
