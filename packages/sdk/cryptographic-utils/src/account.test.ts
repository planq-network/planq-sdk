  ...
  describe('.validateMnemonic()', () => {
    const testMnemonics = {
      ...
      [MnemonicLanguages.french]:
        'texte succès lexique frégate sévir oiseau lanpeur souvenir mythique onirique pélican opérer foulure enfouir maintien vexer relief aérer citerne ligoter arbitre gomme sénateur dénouer',
