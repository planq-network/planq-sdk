import { isHexString, normalizeAddressWith0x } from '@planq-network/base/lib/address'
import { Address, PlanqTx, EncodedTransaction, ReadOnlyWallet, Signer } from '@planq-network/connect'
...
export abstract class WalletBase<TSigner extends Signer> implements ReadOnlyWallet {
   ...
   */
  async signTransaction(txParams: PlanqTx): Promise<EncodedTransaction> {
    if (!txParams) {
