...
import { PlanqTx, EncodedTransaction, RpcCaller, Signer } from '@planq-network/connect'
import { EIP712TypedData } from '@planq-network/utils/lib/sign-typed-data-utils'
import { decodeSig } from '@planq-network/wallet-base'
...
export class RpcSigner implements Signer {
  ...
  async signRawTransaction(tx: PlanqTx) {
