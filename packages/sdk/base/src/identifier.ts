...
// and @planq-network/phone-utils both need these core identifier generation functions as well.
...
// Docstring is duplicated in @planq-network/identity; make sure to update in both places.
/**
...
/**
 * Helper function for getIdentifierHash in @planq-network/identity, so that this can
