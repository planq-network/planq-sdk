import { Address, trimLeading0x } from '@planq-network/base'
import { Err, makeAsyncThrowable } from '@planq-network/base/lib/result'
import { toChecksumAddress } from '@planq-network/utils/lib/address'
...
export class AuthorizedSignerAccessor {
  ...
  async write(
    ...
    const signature = await this.wrapper.kit
      .getWallet()!
      .signTypedData(this.wrapper.self, typedData)
