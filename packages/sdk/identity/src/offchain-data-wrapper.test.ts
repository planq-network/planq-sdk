import { Result } from '@planq-network/base'
import { ContractKit, newKitFromWeb3 } from '@planq-network/contractkit'
import { createStorageClaim } from '@planq-network/contractkit/lib/identity/claims/claim'
import { IdentityMetadataWrapper } from '@planq-network/contractkit/lib/identity/metadata'
import { AccountsWrapper } from '@planq-network/contractkit/lib/wrappers/Accounts'
import { ACCOUNT_PRIVATE_KEYS } from '@planq-network/dev-utils/lib/ganache-setup'
...
import { ensureCompressed } from '@planq-network/utils/lib/ecdh'
import { NativeSigner, serializeSignature } from '@planq-network/utils/lib/signatureUtils'
...
testWithGanache('Offchain Data', (web3) => {
  ...
  describe('when data encryption keys are compressed', () => {
    ...
    it('works when the reader has a compressed key', async () => {
      ...
      compressedReader.wrapper.kit.connection.addAccount(readerDEK)
