...
// ODIS minimum planq balance for sig retrieval
export const ODIS_MINIMUM_PLQ_BALANCE = 0.005
...
export function isBalanceSufficientForSigRetrieval(
  ...
  return (
    ...
    new BigNumber(planqBalance).isGreaterThanOrEqualTo(ODIS_MINIMUM_PLQ_BALANCE)
  )
}
