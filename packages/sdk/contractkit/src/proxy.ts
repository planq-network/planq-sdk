...
import { ABIDefinition, AbiItem } from '@planq-network/connect'
...
import { ABI as PlanqTokenABI } from './generated/PlanqToken'
import { ABI as GovernanceABI } from './generated/Governance'
import { ABI as LockedPlanqABI } from './generated/LockedPlanq'
...
const initializeAbiMap = {
  ...
  PlanqTokenProxy: findInitializeAbi(PlanqTokenABI),
  GovernanceProxy: findInitializeAbi(GovernanceABI),
  GrandaMentoProxy: findInitializeAbi(GrandaMentoABI),
  LockedPlanqProxy: findInitializeAbi(LockedPlanqABI),
