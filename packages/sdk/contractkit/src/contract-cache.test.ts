...
describe('getContract()', () => {
  ...
  test('should create a new instance when an address is provided', async () => {
    ...
    const contract1 = await contractCache.getContract(PlanqContract.MultiSig, address1)
    const contract2 = await contractCache.getContract(PlanqContract.MultiSig, address2)
