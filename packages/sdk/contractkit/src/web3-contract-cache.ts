...
export const ContractFactories = {
  ...
  [PlanqContract.MetaTransactionWalletDeployer]:
    newMetaTransactionWalletDeployer,
...
const StableToContract = {
  [StableToken.aEUR]: PlanqContract.StableTokenEUR,
  [StableToken.aUSD]: PlanqContract.StableToken,
  [StableToken.aREAL]: PlanqContract.StableTokenBRL,
};

const StableToExchange = {
  [StableToken.aEUR]: PlanqContract.ExchangeEUR,
  [StableToken.aUSD]: PlanqContract.Exchange,
  [StableToken.aREAL]: PlanqContract.ExchangeBRL,
};
...
export class Web3ContractCache {
  ...
  getExchange(stableToken: StableToken = StableToken.aUSD) {
  ...
  getStableToken(stableToken: StableToken = StableToken.aUSD) {
  ...
  public invalidateContract<C extends keyof typeof ContractFactories>(
    contract: C
  ) {
