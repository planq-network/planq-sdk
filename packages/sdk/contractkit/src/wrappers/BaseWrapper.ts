import { bufferToHex, ensureLeading0x } from '@planq-network/base/lib/address'
import { zip } from '@planq-network/base/lib/collections'
import {
...
import { IPlanqVersionedContract } from '../generated/IPlanqVersionedContract'
import { ContractVersion } from '../versions'

/** Represents web3 native contract Method */
type Method<I extends any[], O> = (...args: I) => PlanqTxObject<O>
...
export abstract class BaseWrapper<T extends Contract> {
  protected _version?: T['methods'] extends IPlanqVersionedContract['methods']
    ? ContractVersion
    : never
 ...
 * it always return a function of type: (...args:InputArgs) => PlanqTransactionObject<Output>
 *
 * cases:
 *  - methodFn
 *  - parseInputArgs => methodFn
