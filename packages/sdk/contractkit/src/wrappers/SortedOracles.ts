...
export class SortedOraclesWrapper extends BaseWrapper<SortedOracles> {
   ...
   * @param target The ReportTarget, either PlanqToken or currency pair
   * @param value The amount of `token` equal to one PLQ.
   */
  async report(
    target: ReportTarget,
  ...
  /**
   * Updates an oracle value and the median.
   * @param value The amount of US Dollars equal to one PLQ.
   ...
   * @param target The ReportTarget, either PlanqToken or currency pair in question
