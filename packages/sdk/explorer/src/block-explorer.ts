...
import { PROXY_ABI } from '@planq-network/contractkit/lib/proxy'
...
const isCoreContract = (contract: string): contract is PlanqContract => contract in PlanqContract
...
export class BlockExplorer {
  ...
  async updateContractDetailsMapping(name: PlanqContract, address: string) {
  ...
  async tryParseTx(tx: PlanqTxPending): Promise<ParsedTx | null> {
