...
export const mockContractAddress = "0x9DabFe01de024C681320eb80FBc64EccEaa58ca2";

export const PRIVATE_KEY1 =
  "535029bfb19fe5440dbd549b88fbf5ee847b059485e4eafc2a3e3bdfbf9b31ac";
...
export const PRIVATE_KEY3 =
  "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890fffff1d";
export const ACCOUNT_ADDRESS3 = normalizeAddressWith0x(
