import { hexToBuffer, retryAsyncWithBackOffAndTimeout } from '@planq-network/base'
...
import { trimLeading0x } from '@planq-network/utils/lib/address'
import { verifySignature } from '@planq-network/utils/lib/signatureUtils'

import Logger from 'bunyan'
import crypto from 'crypto'
import { Request } from 'express'
import { fetchEnv, rootLogger } from '../index'
import {
...
export async function authenticateUser<R extends PhoneNumberPrivacyRequest>(
  ...
  // (https://github.com/planq-network/planq-sdk/issues/9803)
...
// For general signing, use SignatureUtils in @planq-network/utils
