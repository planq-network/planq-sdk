import { ErrorMessage } from '@planq-network/phone-number-privacy-common'
import { Domain, domainHash } from '@planq-network/phone-number-privacy-common/lib/domains'
...
export async function updateDomainStateRecord<D extends Domain>(
  ...
  return doMeteredSql(
    ...
    async () => {
      ...
      // Consider optimizing in the future: https://github.com/planq-network/planq-sdk/issues/9855
