import { KeyVersionInfo, WarningMessage } from '@planq-network/phone-number-privacy-common'
import { getSignerVersion } from '@planq-network/phone-number-privacy-signer/src/config'
...
describe('pnp threshold state', () => {
  ...
  // result of https://github.com/planq-network/planq-sdk/issues/9826
