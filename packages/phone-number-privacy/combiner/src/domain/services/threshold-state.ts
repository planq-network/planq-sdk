import { DomainRequest, DomainState, KeyVersionInfo } from '@planq-network/phone-number-privacy-common'
...
export function findThresholdDomainState<R extends DomainRequest>(
  ...
  const domainStatesAscendingByTimestampRestrictiveness = domainStatesWithThresholdCounter.sort(
    ...
    /**
     * Please see '@planq-network/phone-number-privacy-common/src/domains/sequential-delay.ts'
