...
export class MetricCollector {
  ...
  constructor(logger: Logger) {
    ...
    this.exchangeApiRequestErrorCounter = new Counter({
      ...
      help: 'Counts the number of exchange API request errors and their http status code or other type of error',
    ...
    this.oracleBalanceValueGauge = new Gauge({
      ...
      help: 'PLANQ balance of the oracle address',
      labelNames: ['oracleAddress'],
    })

    this.potentialReportValueGauge = new Gauge({
      name: 'oracle_potential_report_value',
      help: 'Gauge to show the most recently evaluated price to report when using block-based reporting',
    ...
    this.transactionSuccessCountCounter = new Counter({
      ...
      help: 'Counts the number of successful transactions defined by type that have been mined on chain',
      labelNames: ['type', 'currencyPair'],
    })
