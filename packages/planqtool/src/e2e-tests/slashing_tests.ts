...
describe('slashing tests', function (this: any) {
  ...
  describe('test slashing for downtime', () => {
    ...
    it('slash for downtime', async function (this: any) {
      ...
      const balance = await lockedPlanq.getAccountTotalLockedPlanq(signer)
      // Penalty is defined to be 100 cGLD in migrations, locked planq is 10000 cGLD for a validator
  ...
  describe('test slashing for double signing', () => {
    ...
    it('slash for double signing', async function (this: any) {
      ...
      // Penalty is defined to be 9000 cGLD in migrations, locked planq is 10000 cGLD for a validator, so after slashing locked planq is 1000cGld
      const balance = await lockedPlanq.getAccountTotalLockedPlanq(signer)
