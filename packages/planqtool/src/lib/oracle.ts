import { ensureLeading0x } from '@planq-network/utils/src/address'
...
export function getOracleDeployerForContext(
  ...
  return getDeployer(planqEnv, context, currencyPair, useForno, clusterManager)
}
...
function getAksHsmOracleDeployer(
  ...
  return new AksHsmOracleDeployer(deploymentConfig, planqEnv)
}
...
function getAwsHsmOracleDeployer(
  ...
  return new AwsHsmOracleDeployer(deploymentConfig, planqEnv)
}
...
function getPrivateKeyOracleDeployer(
  ...
  return new PrivateKeyOracleDeployer(deploymentConfig, planqEnv)
}
