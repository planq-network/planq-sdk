...
import { BlockExplorer, newBlockExplorer } from '@planq-network/explorer/lib/block-explorer'
import { LogExplorer, newLogExplorer } from '@planq-network/explorer/lib/log-explorer'
...
export const handler = async (argv: ListArgv) => {
  ...
  const web3 = await getWeb3Client(argv.planqEnv)
