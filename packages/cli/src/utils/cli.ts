import { PlanqTransactionObject, PlanqTx, EventLog, parseDecodedParams } from '@planq-network/connect'
...
// TODO: How can we deploy contracts with the Planq provider w/o a PlanqTransactionObject?
export async function displayWeb3Tx(name: string, txObj: any, tx?: Omit<PlanqTx, 'data'>) {
...
export async function displaySendTx<A>(
  name: string,
  txObj: PlanqTransactionObject<A>,
