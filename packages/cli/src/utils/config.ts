...
export interface PlanqConfig {
  node: string
  gasCurrency: string
}

export const defaultConfig: PlanqConfig = {
...
export function readConfig(configDir: string): PlanqConfig {
...
export function writeConfig(configDir: string, configObj: PlanqConfig) {
