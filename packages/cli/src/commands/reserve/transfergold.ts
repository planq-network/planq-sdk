...
export default class TransferPlanq extends BaseCommand {
  static description = 'Transfers reserve planq to other reserve address'

  static flags = {
    ...BaseCommand.flags,
    value: flags.string({ required: true, description: 'The unit amount of PLQ' }),
  ...
  static examples = [
    'transferplanq --value 9000 --to 0x91c987bf62D25945dB517BDAa840A6c661374402 --from 0x5409ed021d9299bf6814279a6a1411a7e866a631',
    'transferplanq --value 9000 --to 0x91c987bf62D25945dB517BDAa840A6c661374402 --from 0x5409ed021d9299bf6814279a6a1411a7e866a631 --useMultiSig',
  ]
  ...
  async run() {
    ...
    const reserveTx = await reserve.transferPlanq(to, value)
    const tx =
      reserveSpenderMultiSig === undefined
        ? reserveTx
        : await reserveSpenderMultiSig.submitOrConfirmTransaction(reserve.address, reserveTx.txo)
    await displaySendTx<string | void | boolean>('transferPlanqTx', tx)
  }
}
