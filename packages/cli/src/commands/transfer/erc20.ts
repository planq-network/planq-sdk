import { Ierc20 } from '@planq-network/contractkit/lib/generated/IERC20'
import { Erc20Wrapper } from '@planq-network/contractkit/lib/wrappers/Erc20Wrapper'
...
export default class TransferErc20 extends BaseCommand {
  ...
  async run() {
    ...
    let planqToken: Erc20Wrapper<Ierc20>
    try {
      planqToken = await this.kit.contracts.getErc20(res.flags.erc20Address)
      // this call allow us to check if it is a valid erc20
      await planqToken.balanceOf(res.flags.from)
    } catch {
