...
contract GovernanceHarness is Governance {
  ...
  /* Override */
  LockedPlanqHarness lockedPlanq;
  function getLockedPlanq() internal view returns (ILockedPlanq) {
    return lockedPlanq;
  }

  function getTotalLockedPlanq() public view returns (uint256) {
    return lockedPlanq.getTotalLockedPlanq();
  }
