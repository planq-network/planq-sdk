...
#
# Example:
# `./scripts/bash/verify_release_planq_balances.sh -n development -o grantsOut.json -c releasePlanqExampleConfigs.json
...
yarn run build && \
yarn run truffle exec ./scripts/truffle/verify_release_planq_contracts.js \
