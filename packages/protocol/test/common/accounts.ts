...
import { parseSolidityStringArray } from '@planq-network/utils/lib/parsing'
import { authorizeSigner as buildAuthorizeSignerTypedData } from '@planq-network/utils/lib/typed-data-constructors'
import { generateTypedDataHash } from '@planq-network/utils/src/sign-typed-data-utils'
import { parseSignatureWithoutPrefix } from '@planq-network/utils/src/signatureUtils'
...
contract('Accounts', (accounts: string[]) => {
  ...
  const name = 'Account'
  const metadataURL = 'https://planq.network'
