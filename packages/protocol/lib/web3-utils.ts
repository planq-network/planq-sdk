...
import { Address, PlanqTxObject } from '@planq-network/connect';
import { setAndInitializeImplementation } from '@planq-network/protocol/lib/proxy-utils';
import { PlanqContractName } from '@planq-network/protocol/lib/registry-utils';
import { signTransaction } from '@planq-network/protocol/lib/signing-utils';
...
import { PlanqTokenInstance, MultiSigInstance, OwnableInstance, ProxyContract, ProxyInstance, RegistryInstance } from 'types';
...
export async function convertFromContractDecimals(
  ...
  contract: PlanqTokenInstance | StableTokenInstance
) {
