    ...
    Ownable
{
   ...
   * @param value The PLQ value to be sent with the meta-transaction.
   ...
   */
    function getMetaTransactionDigest(
        ...
        bytes32 structHash = _getMetaTransactionStructHash(
            destination,
            value,
            data,
            _nonce
        ...
        return
            Signatures.toEthSignedTypedDataHash(
   ...
   * @param value The PLQ value to be sent with the transaction.
   ...
   * @param values The PLQ value to be sent with each transaction.
