...
library CIP20Lib {
    ...
    function createBlake2sConfig(
        ...
        require(
            keyLength <= 32,
            "CIP20Lib/createBlake2sConfig -- keyLength must be 32 or less"
        );
    ...
    // to a bytes1.
    function writeU8(bytes32 b, uint8 offset, uint8 toWrite)
        private
        pure
        returns (bytes32)
    {
    ...
    function writeLEU32(bytes32 b, uint8 offset, uint32 toWrite)
        private
        pure
        returns (bytes32)
    {
    ...
    function writeLEU16(bytes32 b, uint8 offset, uint16 toWrite)
        private
        pure
        returns (bytes32)
    {
