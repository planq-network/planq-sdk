...
contract CIP20Test {
    ...
    function sha3_256(bytes calldata input)
        external
        view
    ...
    function sha3_512(bytes calldata input)
        external
        view
        returns (bytes memory)
    {
    ...
    function keccak512(bytes calldata input)
        external
        view
        returns (bytes memory)
    {
    ...
    function sha2_512(bytes calldata input)
        external
        view
        returns (bytes memory)
    {
    ...
    function blake2s(bytes calldata input)
        external
        view
        returns (bytes memory)
    {
