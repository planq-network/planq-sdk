...
contract Common {
    ...
    function fpNormalTest(uint256 a1, uint256 a2)
        external
        view
        returns (uint256, uint256)
    {
    ...
    function fpNormal2Test(uint256 a, uint256 idx)
        external
        view
        returns (uint256, uint256)
    {
    ...
    function testDeserialize(bytes memory h)
        public
        pure
...
contract BLS12_381Passthrough is Common {
        ...
        returns (bytes memory)
    {
        ...
        B12.G1MultiExpArg[] memory input = new B12.G1MultiExpArg[](
            args.length / 160
        );
        ...
        returns (bytes memory)
    {
        ...
        B12.G2MultiExpArg[] memory input = new B12.G2MultiExpArg[](
            args.length / 288
        );
