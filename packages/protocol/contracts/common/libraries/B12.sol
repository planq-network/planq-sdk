...
library B12 {
    ...
    function fpAdd3(uint256 a, uint256 b, uint256 c)
        internal
        pure
        returns (Fp memory)
    {
    ...
    function fpAdd4(uint256 a, uint256 b, uint256 c, uint256 d)
        internal
        pure
        returns (Fp memory)
    {
    ...
    function fpMul(Fp memory a, Fp memory b) internal view returns (Fp memory) {
        ...
        res = fpAdd(
            res,
            fpNormal2(fpAdd4(a1 * b4, a2 * b3, a3 * b2, a4 * b1), 48)
        );
    ...
    function fp2Add(Fp2 memory a, Fp2 memory b)
        internal
        pure
        returns (Fp2 memory)
    {
    ...
    function fp2Mul(Fp2 memory a, Fp2 memory b)
        internal
        view
        returns (Fp2 memory)
    {
    ...
    function fpNormal2(Fp memory a, uint256 idx)
        internal
        view
        returns (Fp memory)
    {
    ...
    function mapToG1(
        ...
        Fp memory res = fpAdd(
            fpModExp(x, 3, Fp(BLS12_377_BASE_A, BLS12_377_BASE_B)),
            one
        );
        Fp memory sqhint1 = fpModExp(
            hint1,
            2,
            Fp(BLS12_377_BASE_A, BLS12_377_BASE_B)
        );
        Fp memory sqhint2 = fpModExp(
            hint2,
            2,
            Fp(BLS12_377_BASE_A, BLS12_377_BASE_B)
        );
    ...
    function parsePoint(bytes memory h, uint256 offset)
        internal
        pure
        returns (Fp memory, bool)
    {
    ...
    function parseSimplePoint(bytes memory h, uint256 offset)
        internal
        pure
        returns (Fp memory)
    {
    ...
    function parseSimplePoint(bytes memory h, uint256 offset, Fp memory p)
        internal
        pure
    {
        uint256 a;
    ...
    function parsePoint(bytes memory h)
        internal
        pure
        returns (Fp memory, bool)
    {
    ...
    function parseRandomPoint(bytes memory h)
        internal
        pure
        returns (Fp memory, bool)
    {
    ...
    function readFp2(bytes memory h, uint256 offset)
        internal
        pure
        returns (Fp2 memory)
    {
    ...
    function readFp2(bytes memory h, uint256 offset, Fp2 memory p)
        internal
        pure
    {
    ...
    function readG2(bytes memory h, uint256 offset)
        internal
        pure
    ...
    function readG2(bytes memory h, uint256 offset, G2Point memory p)
        internal
        pure
    {
