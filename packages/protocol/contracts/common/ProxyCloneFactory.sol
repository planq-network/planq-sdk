...
contract ProxyCloneFactory is Ownable {
   ...
   */
    function setImplementationAddress(address _proxyImplementationAddress)
        external
        onlyOwner
    {
   ...
   */
    function clone(address _proxyImplementationAddress)
        internal
   ...
   */
    function deploy(address implementation, bytes calldata initCallData)
        external
    {
        ...
        proxyClone._setAndInitializeImplementation(
            implementation,
            initCallData
        );
