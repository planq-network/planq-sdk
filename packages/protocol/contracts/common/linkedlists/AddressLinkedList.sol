...
library AddressLinkedList {
   ...
   */
    function contains(LinkedList.List storage list, address key)
        public
        view
        returns (bool)
    {
   ...
   */
    function headN(LinkedList.List storage list, uint256 n)
        public
        view
   ...
   */
    function getKeys(LinkedList.List storage list)
        public
        view
        returns (address[] memory)
    {
