...
library IntegerSortedLinkedList {
   ...
   */
    function popN(SortedLinkedList.List storage list, uint256 n)
        public
   ...
   */
    function contains(SortedLinkedList.List storage list, uint256 key)
        public
        view
        returns (bool)
    {
   ...
   */
    function getValue(SortedLinkedList.List storage list, uint256 key)
        public
        view
        returns (uint256)
    {
