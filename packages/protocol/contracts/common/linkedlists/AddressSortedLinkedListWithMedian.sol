...
library AddressSortedLinkedListWithMedian {
   ...
   */
    function remove(SortedLinkedListWithMedian.List storage list, address key)
        public
    {
   ...
   */
    function getHead(SortedLinkedListWithMedian.List storage list)
        external
        view
        returns (address)
    {
   ...
   */
    function getMedian(SortedLinkedListWithMedian.List storage list)
        external
        view
        returns (address)
    {
   ...
   */
    function getTail(SortedLinkedListWithMedian.List storage list)
        external
        view
        returns (address)
    {
