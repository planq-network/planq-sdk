  ...
  UsingRegistry
{
  ...
  bytes32 constant ValidatorSigner = keccak256(abi.encodePacked("planq.network/core/validator"));
  bytes32 constant AttestationSigner = keccak256(abi.encodePacked("planq.network/core/attestation"));
  bytes32 constant VoteSigner = keccak256(abi.encodePacked("planq.network/core/vote"));
