    ...
    UsingPrecompiles
{
    ...
    struct SlashingIncentives {
        // Value of LockedPlanq to slash from the account.
        uint256 penalty;
        // Value of LockedPlanq to send to the observer.
        uint256 reward;
    }
   ...
   */
    function setSlashingIncentives(uint256 penalty, uint256 reward)
        public
        onlyOwner
    {
   ...
   */
    function groupMembershipAtBlock(
        ...
        return
            getValidators().groupMembershipInEpoch(
                validator,
                epoch.sub(1),
    ...
    function performSlashing(
        ...
        address group = groupMembershipAtBlock(
            validator,
            startBlock,
            groupMembershipHistoryIndex
        );
