...
interface IReleasePlanq {
    function transfer(address, uint256) external;
    function unlockPlanq(uint256) external;
    function withdrawLockedPlanq(uint256) external;
    function authorizeVoteSigner(address payable, uint8, bytes32, bytes32)
        external;
    function authorizeValidatorSigner(address payable, uint8, bytes32, bytes32)
        external;
    ...
    function revokePending(address, uint256, address, address, uint256)
        external;
    ...
    function lockPlanq(uint256) external;
    function relockPlanq(uint256, uint256) external;
    function setAccount(
        string calldata,
        bytes calldata,
        address,
