...
interface IValidators {
    ...
    function setValidatorScoreParameters(uint256, uint256)
        external
        returns (bool);
    function setGroupLockedPlanqRequirements(uint256, uint256)
        external
        returns (bool);
    function setValidatorLockedPlanqRequirements(uint256, uint256)
        external
        returns (bool);
    ...
    function calculateGroupEpochScore(uint256[] calldata)
        ...
        view
        returns (uint256);
    function getAccountLockedPlanqRequirement(address)
        external
        view
        returns (uint256);
    function meetsAccountLockedPlanqRequirements(address)
        external
        view
        returns (bool);
    ...
    function groupMembershipInEpoch(address, uint256, uint256)
        external
        view
        returns (address);

    // only registered contract
    function updateEcdsaPublicKey(address, address, bytes calldata)
        external
        returns (bool);
