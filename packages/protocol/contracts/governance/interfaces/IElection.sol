...
interface IElection {
    ...
    function revokeActive(address, uint256, address, address, uint256)
        external
        returns (bool);
    function revokeAllActive(address, address, address, uint256)
        external
        returns (bool);
    ...
    function allowedToVoteOverMaxNumberOfGroups(address)
        external
        returns (bool);
    ...
    // only VM
    function distributeEpochRewards(address, uint256, address, address)
        external;
}
