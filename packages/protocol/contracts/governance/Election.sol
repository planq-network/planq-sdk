  ...
  CalledByVm
{
  ...
  function getGroupEpochRewards(
    ...
    if (!validators.meetsAccountLockedPlanqRequirements(group) || votes.active.total <= 0) {
      return 0;
    }
  ...
  ) external nonReentrant onlyRegisteredContract(LOCKED_PLANQ_REGISTRY_ID) returns (uint256) {
