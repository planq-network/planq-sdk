  ...
  UsingPrecompiles
{
  ...
  function votePartially(
    ...
    address account = getAccounts().voteSignerToAccount(msg.sender);
    uint256 totalLockedPlanq = getLockedPlanq().getAccountTotalLockedPlanq(account);
   ...
   */
  function getAmountOfPlanqUsedForVoting(address account) public view returns (uint256) {
    Voter storage voter = voters[account];
