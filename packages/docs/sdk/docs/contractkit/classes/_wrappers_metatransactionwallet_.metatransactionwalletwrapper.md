[@planq-network/contractkit](../README.md) › [Globals](../globals.md) › ["wrappers/MetaTransactionWallet"](../modules/_wrappers_metatransactionwallet_.md) › [MetaTransactionWalletWrapper](_wrappers_metatransactionwallet_.metatransactionwalletwrapper.md)
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:179](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L179)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:192](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L192)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:155](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L155)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:127](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L127)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:149](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L149)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:156](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L156)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:157](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L157)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:170](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L170)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:165](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L165)*

#### Type declaration:

▸ (`newSigner`: Address): *PlanqTransactionObject‹void›*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:160](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L160)*

#### Type declaration:

▸ (`newOwner`: Address): *PlanqTransactionObject‹void›*
...
▸ **executeMetaTransaction**(`tx`: [TransactionInput](../modules/_wrappers_metatransactionwallet_.md#transactioninput)‹any›, `signature`: Signature): *PlanqTransactionObject‹string›*

*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:68](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L68)*
...
▸ **executeTransaction**(`tx`: [TransactionInput](../modules/_wrappers_metatransactionwallet_.md#transactioninput)‹any›): *PlanqTransactionObject‹string›*

*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:38](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L38)*
...
▸ **executeTransactions**(`txs`: Array‹[TransactionInput](../modules/_wrappers_metatransactionwallet_.md#transactioninput)‹any››): *PlanqTransactionObject‹object›*

*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:51](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L51)*
...
**Returns:** *PlanqTransactionObject‹object›*
...
▸ **signAndExecuteMetaTransaction**(`tx`: [TransactionInput](../modules/_wrappers_metatransactionwallet_.md#transactioninput)‹any›): *Promise‹PlanqTransactionObject‹string››*

*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:112](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L112)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:93](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L93)*
...
*Defined in [packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts:193](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/contractkit/src/wrappers/MetaTransactionWallet.ts#L193)*
