[@planq-network/identity](../README.md) › ["odis/bls-blinding-client"](../modules/_odis_bls_blinding_client_.md) › [WasmBlsBlindingClient](_odis_bls_blinding_client_.wasmblsblindingclient.md)
