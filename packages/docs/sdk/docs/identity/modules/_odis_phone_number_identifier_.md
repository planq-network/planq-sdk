[@planq-network/identity](../README.md) › ["odis/phone-number-identifier"](_odis_phone_number_identifier_.md)
...
* [ODIS_MINIMUM_PLQ_BALANCE](_odis_phone_number_identifier_.md#const-odis_minimum_planq_balance)
...
### `Const` ODIS_MINIMUM_PLQ_BALANCE

• **ODIS_MINIMUM_PLQ_BALANCE**: *0.005* = 0.005

*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:21](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L21)*
...
*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:19](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L19)*
...
*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:88](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L88)*
...
*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:103](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L103)*
...
*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:153](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L153)*
...
*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:38](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L38)*
...
*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:136](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L136)*
...
▸ **isBalanceSufficientForSigRetrieval**(`dollarBalance`: BigNumber.Value, `planqBalance`: BigNumber.Value): *boolean*

*Defined in [packages/sdk/identity/src/odis/phone-number-identifier.ts:161](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/identity/src/odis/phone-number-identifier.ts#L161)*
