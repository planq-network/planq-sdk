[@planq-network/wallet-hsm-azure](../README.md) › ["azure-key-vault-client"](../modules/_azure_key_vault_client_.md) › [AzureKeyVaultClient](_azure_key_vault_client_.azurekeyvaultclient.md)
