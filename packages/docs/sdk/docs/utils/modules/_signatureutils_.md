[@planq-network/utils](../README.md) › ["signatureUtils"](_signatureutils_.md)
...
*Defined in [signatureUtils.ts:88](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/utils/src/signatureUtils.ts#L88)*
