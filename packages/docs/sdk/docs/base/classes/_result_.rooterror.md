[@planq-network/base](../README.md) › ["result"](../modules/_result_.md) › [RootError](_result_.rooterror.md)
...
*Defined in [packages/sdk/base/src/result.ts:66](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/base/src/result.ts#L66)*
