[@planq-network/base](../README.md) › ["address"](_address_.md)
...
*Defined in [packages/sdk/base/src/address.ts:30](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/base/src/address.ts#L30)*
