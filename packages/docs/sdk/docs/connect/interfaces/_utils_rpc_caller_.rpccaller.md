[@planq-network/connect](../README.md) › [Globals](../globals.md) › ["utils/rpc-caller"](../modules/_utils_rpc_caller_.md) › [RpcCaller](_utils_rpc_caller_.rpccaller.md)
...
*Defined in [utils/rpc-caller.ts:64](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/connect/src/utils/rpc-caller.ts#L64)*
...
*Defined in [utils/rpc-caller.ts:65](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/connect/src/utils/rpc-caller.ts#L65)*
