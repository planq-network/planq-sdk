[@planq-network/connect](../README.md) › [Globals](../globals.md) › ["utils/rpc-caller"](_utils_rpc_caller_.md)
...
*Defined in [utils/rpc-caller.ts:36](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/connect/src/utils/rpc-caller.ts#L36)*
...
*Defined in [utils/rpc-caller.ts:8](https://github.com/planq-network/planq-sdk/blob/master/packages/sdk/connect/src/utils/rpc-caller.ts#L8)*
