...
## `planqcli validator:affiliate GROUPADDRESS`
...
_See code: [src/commands/validator/affiliate.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/affiliate.ts)_

## `planqcli validator:deaffiliate`
...
_See code: [src/commands/validator/deaffiliate.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/deaffiliate.ts)_

## `planqcli validator:deregister`

Deregister a Validator. Approximately 60 days after the validator is no longer part of any group, it will be possible to deregister the validator and start unlocking the PLQ. If you wish to deregister your validator, you must first remove it from it's group, such as by deaffiliating it, then wait the required 60 days before running this command.
...
_See code: [src/commands/validator/deregister.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/deregister.ts)_

## `planqcli validator:downtime-slash`
...
_See code: [src/commands/validator/downtime-slash.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/downtime-slash.ts)_

## `planqcli validator:force-deaffiliate`
...
_See code: [src/commands/validator/force-deaffiliate.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/force-deaffiliate.ts)_

## `planqcli validator:list`
...
_See code: [src/commands/validator/list.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/list.ts)_

## `planqcli validator:register`
...
_See code: [src/commands/validator/register.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/register.ts)_

## `planqcli validator:requirements`
...
_See code: [src/commands/validator/requirements.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/requirements.ts)_

## `planqcli validator:set-bitmaps`
...
_See code: [src/commands/validator/set-bitmaps.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/set-bitmaps.ts)_

## `planqcli validator:show VALIDATORADDRESS`
...
_See code: [src/commands/validator/show.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/show.ts)_

## `planqcli validator:signed-blocks`
...
_See code: [src/commands/validator/signed-blocks.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/signed-blocks.ts)_

## `planqcli validator:status`
...
_See code: [src/commands/validator/status.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/status.ts)_

## `planqcli validator:update-bls-public-key`
...
_See code: [src/commands/validator/update-bls-public-key.ts](https://github.com/planq-network/planq-sdk/tree/master/packages/cli/src/commands/validator/update-bls-public-key.ts)_
